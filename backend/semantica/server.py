...
if EXPLORER_AVAILABLE:
    try:
        ...
        app.include_router(knowledge_engineering.router, dependencies=_auth)

        logging.info("Explorer, Knowledge Engineering, Vocabulary, SPARQL, Provenance, and Ontology API routes successfully mounted.")
